...
from mantis_ctl.event_metrics.exceptions import MetricNotFound
from mantis_ctl.event_metrics.query import Query, QueryBatch
from mantis_ctl.event_metrics.utils import _current_time_us


class MetricConnection:
    """Create or connect to an mantis_ctl.event_metrics database.
    ...
    def __init__(self, db_path: Union[str, None] = None):
        if db_path is None:
            _, db_path = tempfile.mkstemp(suffix=".mantis_ctl.event_metrics.db")
